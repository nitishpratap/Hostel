...
?>
<div class="container">
	<h1 class="h1">Reallocation:</h1>
	<div class="form-group">
				<span id="Result">
					
				</span>
			</div>
	<form action="reallocate_database.php" method="post" accept-charset="utf-8">
		<!-- Institute -->
			<div class="form-group">
		...
		<!-- show error -->
			...
			<!-- hidden content student old roomNo-->
			<div class="form-group">
					<input type="hidden" name="oldroomNo" class="form-control" value="<?php echo $room;?>" >
			</div> 

			<button type="submit" id="submit" name="Submit" value="Allocate" class="btn btn-success btn-lg">Reallocate</button>
	</form>
</div>
